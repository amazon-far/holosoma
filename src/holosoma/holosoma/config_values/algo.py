...
ppo_multi_motion = PPOAlgoConfig(
    _target_="holosoma.agents.ppo.ppo_multi_motion.PPO",
    _recursive_=False,
    config=PPOConfig(
        num_learning_epochs=8,
        num_mini_batches=4,
...
fast_sac_multi_motion = FastSACAlgoConfig(
    _target_="holosoma.agents.fast_sac.fast_sac_agent_multi_motion.FastSACAgent",
    _recursive_=False,
    config=FastSACConfig(
        num_learning_iterations=50000,
        critic_learning_rate=3e-4,
...
DEFAULTS = {
    "ppo": ppo,
    "fast_sac": fast_sac,
    "ppo_multi_motion": ppo_multi_motion,
    "fast_sac_multi_motion": fast_sac_multi_motion,
}
