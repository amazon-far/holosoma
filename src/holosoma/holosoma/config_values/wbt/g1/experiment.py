...
g1_29dof_wbt_multi_motion = ExperimentConfig(
    training=TrainingConfig(
        project="WholeBodyTracking",
        name="g1_29dof_wbt_manager",
        num_envs=8192,
    ...
    env_class="holosoma.envs.wbt.wbt_manager.WholeBodyTrackingManager",
    algo=replace(
        algo.ppo_multi_motion,
        config=replace(
            algo.ppo_multi_motion.config,
            num_learning_iterations=40000,
            save_interval=4000,
            entropy_coef=0.005,
            init_noise_std=1.0,
...
g1_29dof_wbt_fast_sac_multi_motion = ExperimentConfig(
    training=TrainingConfig(
        project="WholeBodyTracking",
        name="g1_29dof_wbt_fast_sac_manager",
        num_envs=8192,
    ...
    env_class="holosoma.envs.wbt.wbt_manager.WholeBodyTrackingManager",
    algo=replace(
        algo.fast_sac_multi_motion,
        config=replace(
            algo.fast_sac_multi_motion.config,
            num_learning_iterations=400000,
            v_max=20.0,
            v_min=-20.0,
            gamma=0.99,  # For motion tracking, high gamma + high num_steps is better
...
__all__ = [
    ...
    "g1_29dof_wbt_multi_motion",
    "g1_29dof_wbt_fast_sac_multi_motion",
]
