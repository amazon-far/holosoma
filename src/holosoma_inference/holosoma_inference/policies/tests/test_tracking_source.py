...
Covers the fp-e59.A contract that ``TrackingSource`` implementations
must satisfy, and confirms the default ``NullTrackingSource`` behavior
produces the no-op fallback that keeps pre-.A behavior byte-identical.
"""
